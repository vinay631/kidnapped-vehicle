...
public:
	...
	std::string replaceTrailingSpace(std::string s);
	std::stringstream copyToStringStream(std::vector<double> v);
	std::stringstream copyToStringStream(std::vector<int> v);
